...
function DetailStaff() {
  ...
  useEffect(() => {
    if (id) {
      fetch(`http://localhost:8080/promotion/readdis/${id}`)
          ...
          <div className="grid grid-cols-3 items-center">
            ...
            <div className="col-span-2">
              <Datepicker
                useRange={false}
                asSingle={true}
                value={{ startDate: staff.datestart, endDate: staff.datestart }}
            ...
            <div className="col-span-2">
              <Datepicker
                useRange={false}
                asSingle={true}
                value={{ startDate: staff.dateend, endDate: staff.dateend }}
