...
function detailstaff() {
    ...
    return (
        <div className='h-screen'>
            ...
            <p className='my-1 mx-6 font-semibold text-[#C5B182] border-b hj border-[#C5B182] py-2'>แก้ไขพนักงาน</p>

            <div className="flex justify-center">
                <form className="mt-5 w-1/2">
                    <div className="grid grid-cols-4 items-center ">
                        <label htmlFor="st_name" className="block text-sm font-medium leading-6 text-[#73664B]  mt-3 text-left">
                            ชื่อพนักงาน :</label>
                    ...
                    <div className="grid grid-cols-4 items-center ">
                        <label htmlFor="st_username" className="block text-sm font-medium leading-6 text-[#73664B]  mt-3 text-left">
                            ชื่อผู้ใช้งาน :</label>
                        <div className="mt-2 col-span-3">
                            <input
                                required
                    ...
                    <div className="grid grid-cols-4 items-center ">
                        <label htmlFor="st_password" className="block text-sm font-medium leading-6 text-[#73664B]  mt-3 text-left">
                            รหัสผ่าน :</label>
                        <div className="mt-2 col-span-3">
                            <input
                                required
                    ...
                    <div className="grid grid-cols-4 items-center ">
                        <label htmlFor="st_tel" className="block text-sm font-medium leading-6 text-[#73664B]  mt-3 text-left">
                            เบอร์โทร :</label>
                        <div className="mt-2 col-span-3">
                            <input
                                required
                    ...
                    <div className="grid grid-cols-4 items-center ">
                        <label htmlFor="last-name" className="block text-sm font-medium leading-6 text-[#73664B]  mt-3 text-left">
                            แผนก :</label>
                ...
                <div className="w-1/2  mt-10  flex justify-start " >
                    <button>
                        <Link href="/staff/detailstaff"
                            type="button"
                            className=" text-white bg-[#C5B182] focus:outline-none  focus:ring-4 focus:ring-gray-200 font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2 ">
                            ยกเลิก</Link></button>
                    <>
                        {isOpen && (
                    ...
                    }} type="button" className=" mr-5 text-white bg-[#73664B] focus:outline-none  focus:ring-4 focus:ring-gray-200 font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2">
                        เสร็จสิ้น
                    </button>
